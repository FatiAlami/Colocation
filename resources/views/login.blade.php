                    ...
                    <div class="offset-md-2 col-md-8 offset-lg-3 col-lg-6">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="login" role="tabpanel" aria-labelledby="login-tab">
                                ...
                                <!--Login form-->
                                <form class="ts-form" id="form-login" action="/shecklogin" method="get">
                                     @csrf
                                     @method('PUT')
                                    <!--Email-->
                                    ...
                                    <div class="input-group ts-has-password-toggle">
                                        <input type="password" name="password" class="form-control border-right-0" placeholder="Password" value="Sercet_123" required>
                            ...
                            <div class="tab-pane" id="register" role="tabpanel" aria-labelledby="register-tab">
                                ...
                                <form class="ts-form" id="form-register">
                                    ...
                                    <!--Password-->
                                    <div class="input-group ts-has-password-toggle">
                                        <input type="password" class="form-control border-right-0" placeholder="Password" required>
                                        <div class="input-group-append">
                                            <a href="#" class="input-group-text bg-white border-left-0 ts-password-toggle">
                                                <i class="fa fa-eye"></i>
                                            </a>
                                    ...
                                    <!--Repeat Password-->
                                    <div class="input-group ts-has-password-toggle">
                                        <input type="password" class="form-control border-right-0" placeholder="Repeat Password" required>
                                        <div class="input-group-append">
                                            <a href="#" class="input-group-text bg-white border-left-0 ts-password-toggle">
                                                <i class="fa fa-eye"></i>
                                            </a>
